...
一般的图标尺寸都是16px*16px
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/normalize.min.css">
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/bootstrap.min.css">
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/font-awesome.min.css">
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/themify-icons.css">
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/pe-icon-7-stroke.min.css">
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/flag-icon.min.css">
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/cs-skin-elastic.css">
<link rel="stylesheet"
	href="<%=basePath%>user/assets/css/lib/datatable/dataTables.bootstrap.min.css">
<link rel="stylesheet" href="<%=basePath%>user/assets/css/style.css">
<link
	href='<%=basePath%>user/assets/css?family=Open+Sans:400,600,700,800'
					...
					<li class="menu-item-has-children active dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-table"></i><a
								href="<%=basePath%>user/CreateTeam.do">创建战队</a></li>
							<li><i class="fa fa-table"></i><a
								href="<%=basePath%>user/JoinTeam.do">加入战队</a></li>
							<li><i class="fa fa-table"></i><a
								href="<%=basePath%>user/TeamInformation.do">战队信息</a></li>
						</ul></li>
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="menu-icon fa fa-th"></i><a
								href="<%=basePath%>user/MacthList.do">开始比赛</a></li>
						</ul></li>
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-id-badge"></i><a
								href="<%=basePath%>user/Personal_information.do">账户设置</a></li>

							<li><i class="fa fa-id-card-o"></i><a
								href="<%=basePath%>user/Mac.do">系统设置</a></li>
	...
	<div id="right-panel" class="right-panel">
			...
			<div class="top-left">
				<div class="navbar-header">
					<a class="navbar-brand" href="<%=basePath%>home.do"><img
						src="<%=basePath%>user/images/logo.png" alt="Logo"></a> <a
						class="navbar-brand hidden" href="<%=basePath%>home.do"><img
						src="<%=basePath%>user/images/logo2.png" alt="Logo"></a> <a
						...
						<div class="user-area dropdown float-right">
							...
							<div class="user-menu dropdown-menu">
								<a class="nav-link"><i class="fa fa-user"></i>我的账户</a> <a
									...
									href="<%=basePath%>logoin/quit.do"><i class="fa fa-power-off"></i>注销</a>
							</div>
						</div>
					</div>
				</div>
		...
		<script type="text/javascript">
			function myclick(id) {
				$.ajax({
					type : "get",
					url : "<%=basePath%>user/delectnews.do?id=" + id,
					cache : false,
