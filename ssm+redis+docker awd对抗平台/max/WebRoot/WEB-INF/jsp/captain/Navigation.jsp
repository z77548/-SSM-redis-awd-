...
一般的图标尺寸都是16px*16px
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/normalize.min.css">
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/bootstrap.min.css">
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/font-awesome.min.css">
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/themify-icons.css">
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/pe-icon-7-stroke.min.css">
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/flag-icon.min.css">
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/cs-skin-elastic.css">
<link rel="stylesheet"
	href="<%=basePath%>captain/assets/css/lib/datatable/dataTables.bootstrap.min.css">
<link rel="stylesheet" href="<%=basePath%>captain/assets/css/style.css">
<link
	href='<%=basePath%>captain/assets/css?family=Open+Sans:400,600,700,800'
				...
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children active dropdown"><a href="#"
						...
						aria-haspopup="true" aria-expanded="false"> <i
							class="menu-icon fa fa-table"></i>战队
					</a>
						<ul class="sub-menu children dropdown-menu">

							<li><i class="fa fa-table"></i><a
								href="<%=basePath%>captain/team.do">战队管理</a></li>
							<li><i class="fa fa-table"></i><a
								href="<%=basePath%>captain/TeamInformation.do">战队信息修改</a></li>
							<li><i class="fa fa-table"></i><a
								href="<%=basePath%>captain/CompetitionRegistration.do">报名比赛管理</a></li>
						</ul></li>
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="menu-icon fa fa-th"></i><a
								href="<%=basePath%>captain/CompetitionRegistration.do">比赛报名</a></li>
							<li><i class="menu-icon fa fa-th"></i><a
								href="<%=basePath%>captain/MacthList.do">开始比赛</a></li>
						</ul></li>
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-id-badge"></i><a
								href="<%=basePath%>captain/Personal_information.do">账户设置</a></li>

							<li><i class="fa fa-id-card-o"></i><a
								href="<%=basePath%>captain/Mac.do">系统设置</a></li>
	...
	<div id="right-panel" class="right-panel">
			...
			<div class="top-left">
				<div class="navbar-header">
					<a class="navbar-brand" href="<%=basePath%>home.do"><img
						src="<%=basePath%>captain/images/logo.png" alt="Logo"></a> <a
						class="navbar-brand hidden" href="<%=basePath%>home.do"><img
						src="<%=basePath%>captain/images/logo2.png" alt="Logo"></a> <a
					...
					<div class="header-left">
						...
						<div class="user-area dropdown float-right">
							<a href="#" class="dropdown-toggle active" data-toggle="dropdown"
								...
								src="<%=basePath%>captain/images/admin.jpg" alt="captain Avatar">
							</a>

							<div class="captain-menu dropdown-menu">
								<a class="nav-link"><i class="fa fa-captain"></i>我的账户</a> <a
									class="nav-link" href="<%=basePath%>captain/Mac.do"><i
									class="fa fa-cog"></i>系统设置</a> <a class="nav-link"
									href="<%=basePath%>captain/Personal_information.do"><i
									class="fa fa-cog"></i>账户设置</a> <a class="nav-link"
		...
		<script type="text/javascript">
			function myclick(id) {
				$.ajax({
					type : "get",
					url : "<%=basePath%>captain/delectnews.do?id=" + id,
					cache : false,
