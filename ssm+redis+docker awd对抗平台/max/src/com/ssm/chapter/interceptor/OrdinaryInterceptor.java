...
public class OrdinaryInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		try {
			...
			if (ordinaryUsers == null) {
				...
				String sb = "";
				sb = "<script type=\"text/javascript\" charset=\"GB2312\">"
						+ "alert(\"你的账号被挤掉，或者没有登录，或者页面已经过期，请重新登录\");" + "window.location.href='../';" + "</script>";
				out.print(sb);
				out.close();
				return false;
			}
